//
//  UGGotoTestDtlViewController.m
//  UrgooApp
//
//  Created by UrgooDev on 16/5/9.
...
@interface UGGotoTestDtlViewController ()

@end

@implementation UGGotoTestDtlViewController
    ...
    if (pathArr.count>1) {
       ...
       // NSString *urlStr = [NSString stringWithFormat:@"%@%@",UG_HOST,pathArr[accountObj-1]];
        ...
        // 个性标签
           ...
           if  ([pathArr[0] isEqualToString:gotoAssessmentPage]) {
